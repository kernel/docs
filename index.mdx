...
[browser pools](/browsers/pools/overview) are how you take a working automation to production: they keep browsers warm and pre-configured so you skip start-up latency on every task, and idle browsers in a browser pool aren't billed. once you know how to create and drive a browser, browser pools are worth evaluating for almost any production workload.