...
keep an existing credential vault as your source of truth while using KERNEL to fill browser forms. Your trusted backend reads the source credential, copies it into a KERNEL credential item, and updates or deletes that copy as the source changes.
