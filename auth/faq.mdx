...
Managed Auth covers common login flows across a broad range of websites. Site-specific authentication and bot detection can require additional configuration. Test your target flow.
