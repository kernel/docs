...
A successful interactive login can save submitted credentials for automatic reauthentication. During TOTP flows, Kernel attempts to provide the authenticator code automatically. If your login has additional requirements, [contact support](/info/support) to find the best configuration.
