...
A runnable example of embedding the component — provider wiring, appearance customization, and localization — lives in the [`packages/demo` app](https://github.com/kernel/managed-auth-react/tree/main/packages/demo) of the `managed-auth-react` repo. It's a copy-pasteable starting point for embedding the component in your own app.
