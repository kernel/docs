...
Managed Auth creates authenticated browser sessions for your agents and saves them to reusable profiles. Kernel can automatically reauthenticate credential-only flows and attempts to provide TOTP codes when needed. If your login has additional requirements, [contact support](/info/support) to find the best configuration.
