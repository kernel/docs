...
if your own agent must handle navigation, submission, and non-payment forms,
use [vault credential items](/vaults/credentials) with explicit browser fill
instead. vault items don't run login flows or maintain authenticated sessions.
