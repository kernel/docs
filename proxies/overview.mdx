...
<Note>
If you swap the proxy on a browser acquired from a pool, the browser will be baselined back to the pool's default proxy configuration when it is released back to the pool.
</Note>
