...
[Stealth browsers](/browsers/bot-detection/stealth) are automatically assigned a residential proxy. To disable this default proxy and route traffic directly, set `disable_default_proxy` to `true` when creating the browser:
