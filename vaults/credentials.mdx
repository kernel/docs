...
<Warning>
  collection links are bearer credentials. don't include them in agent prompts, logs, analytics, screenshots, or replay. open collection outside the agent-controlled browser.
</Warning>
