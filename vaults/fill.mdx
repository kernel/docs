...
for an authentication workflow using this api, see [Fill from Vault](/auth/fill-from-vault). `fill` also supports other eligible vault items; it isn't specific to authentication or a wallet provider.
