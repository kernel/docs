...
| [link by stripe](/integrations/payments/stripe-link) `card` | ready and unexpired, with the requested card fields available and destination permitted by the card policy |
