...
[Residential proxies](/proxies/residential#restricted-destination-routing) with supported targeting automatically route a maintained set of destinations in these categories — government, banking, payment, postal, and others — through a provider that carries them. The rest of this section applies to destinations outside that set.
