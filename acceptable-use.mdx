...
| Category | Examples |
|---|---|
| Government | Country-specific government domains, and `.gov` on proxy configurations that do not support automatic routing — see [`.gov` support](/proxies/residential#gov-support) |
