...
**Nothing in the table above is prohibited by this policy.** These are destinations our proxy networks will not carry, not destinations you may not visit. Reaching any of them with a Kernel browser is permitted, and the [Prohibited Uses](#prohibited-uses) above are the only limits on where your automation may go.
