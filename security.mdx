...
For questions about our security program, contact [security@kernel.sh](mailto:security@kernel.sh).
...
[Learn more about our Shared Responsibility Model →](/shared-responsibility-model)
...
### 4.5 Device and Workstation Security
...
### 6.3 Incident Investigation and Response
...
- **SOC 2 Type II** — Compliant. Our SOC 2 report is available upon request through our [Trust Center](https://trust.onkernel.com).
...
To learn more about our compliance posture or to request audit reports and security artifacts, visit our [Trust Center](https://trust.onkernel.com).
