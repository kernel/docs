...
| Headful + GPU acceleration | 0.0010666688 / gb-s |

> Note: GPU acceleration is only available on headful browsers. Standby mode is not supported for GPU-accelerated browsers.
