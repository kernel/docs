...
description: "Worked examples for the five jobs people bring to Kernel"
---

Each recipe below is a working shape for one job — what to configure, what to run, and the failure mode to plan for. They assume `KERNEL_API_KEY` is set and you've been through the [quickstart](/start/quickstart).
