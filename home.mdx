...
<Columns className="responsive-columns" cols={4}>
  <Card title="Sandboxed Chromium" img="/images/chromium.png" href="/browsers/create-a-browser">
    We spin up cloud browsers in &lt;30ms with GPU acceleration when needed.
  </Card>
  <Card title="Auth" img="/images/auth.png" href="/auth/overview">
    We manage auth for your agents so you don't have to.
  </Card>
  <Card title="Stealth Mode" img="/images/stealth.png" href="/browsers/bot-detection/overview">
    We solve CAPTCHAs and manage residential proxies to help you see fewer of them.
  </Card>
  <Card title="o11y" img="/images/o11y.png" href="/browsers/replays">
  ...
  <div className="tinker-box-row">
    ...
    <div className="tinker-box-content">
      <p style={{ margin: 0, fontSize: '0.9375rem', lineHeight: 1.6, opacity: 0.8 }}>
        copy and paste this into your AI coding agent (Cursor, Claude, Windsurf, etc.). it installs the Kernel CLI and skills, authenticates you, and opens a live browser session.
      </p>
      <div>
        <CopyPromptButton />
      </div>
