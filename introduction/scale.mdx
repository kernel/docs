...
For the mechanics of standing up a browser pool and acquiring browsers from it, see the [Browser Pools overview](/browsers/pools). This guide covers which architecture to wrap around it.
