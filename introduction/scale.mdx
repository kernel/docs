...
A [browser pool](/browsers/pools) keeps a set of identically-configured browsers warm and ready. Compared to creating browsers on demand, it gives you:
...
- **Reserved, pre-configured capacity** — a fixed set of browsers on your exact configuration, warm before traffic arrives.
