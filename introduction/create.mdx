...
<Columns cols={2}>
  ...
  <Card title="Profiles and auth" href="/auth/overview">
    Persist cookies, storage, and authenticated sessions across runs with a [profile](/auth/profiles), or use [Managed Auth](/auth/overview) to run login flows and monitor session health.
  </Card>
</Columns>
