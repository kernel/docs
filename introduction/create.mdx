...
<Columns cols={2}>
  ...
  <Card title="Profiles and auth" href="/auth/overview">
    Persist cookies, storage, and authenticated sessions across runs with a [profile](/auth/profiles), or learn how to hand supported login flows off to Kernel with [Managed Auth](/auth/managed-auth).
  </Card>
</Columns>
