...
When you're ready to run this in production, the [Browser Pools overview](/browsers/pools/overview) shows how to serve your workload from warm, pre-configured browsers instead of creating one per task.
