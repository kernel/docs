...
<Columns cols={2}>
  ...
  <Card title="Profiles and auth" href="/auth/overview">
    Persist cookies, storage, and authenticated sessions across runs with a [profile](/auth/profiles), or learn how to hand auth off to Kernel entirely with [Managed Auth](/auth/overview).
  </Card>
</Columns>
