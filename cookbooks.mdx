...
<Columns className="responsive-columns" cols={3}>
  <Card title="Human-in-the-loop Credentials" icon="key" href="/browsers/use-vault-credentials-in-browser-agent">
  ...
  <Card title="Jev Browser Use" img="/images/cookbooks/jev.jpg" href="https://www.val.town/x/kernel/jev-browser-use">
    <div className="cookbook-tag">harnesses & models</div>
  ...
  <Card title="Pausing for Captcha Solves" img="/images/cookbooks/captcha-solving.png" href="/browsers/telemetry/pausing-for-captcha-solves">
    <div className="cookbook-tag">common patterns</div>
