...
<Columns className="responsive-columns" cols={3}>
  <Card title="Vault Credentials" icon="key" href="/browsers/use-vault-credentials-in-browser-agent">
    <div className="cookbook-tag">common patterns</div>
    Collect credentials outside your agent and expose a scoped browser fill tool.
  </Card>
