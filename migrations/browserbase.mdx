...
- **Region.** Browsers default to `us-east`. Co-locate your loop with [playwright execution](/browsers/playwright-execution) or the [App Platform](/apps/develop) if latency matters.
