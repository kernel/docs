...
- Added support for runtime proxy configuration [swapping](/proxies/overview#5-update-a-browser%E2%80%99s-proxy), enabling you to change a browser's proxy settings mid-session without restarting.
