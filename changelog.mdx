...
- Added support for [runtime proxy configuration swapping](/browsers/bot-detection/stealth), enabling you to change a browser's proxy settings mid-session without restarting.
