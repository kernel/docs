...
- Added spending cap management to the dashboard billing page, allowing org admins to set and update spending limits directly from the UI. This feature is currently in limited preview.
