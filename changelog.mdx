...
- Updated the Anthropic computer-use [template](https://github.com/kernel/cli/tree/main/pkg/templates) defaults to use claude-sonnet-4-6 for improved agent performance.
- Improved recording resilience by gracefully stopping and restarting recordings during display resize events.
- Fixed 500 errors when starting recordings, localStorage not persisting across profile sessions, and scroll notch count handling in computer-use templates.
