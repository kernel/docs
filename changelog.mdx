...
- Released [Managed Auth](/profiles/managed-auth/overview), allowing agents to securely log into any site without custom auth flows or exposing credentials to the LLM.
