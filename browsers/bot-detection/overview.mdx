---
title: "Overview"
description: "Help your browser agents access websites with anti-detection defaults, stealth mode, proxies, and opt-in Web Bot Auth (WBA)."
---
...
Kernel recommended browser and proxy configurations for websites.
