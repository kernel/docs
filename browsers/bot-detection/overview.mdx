...
Look up the browser and proxy configuration Kernel has verified for a site before your first visit. When Kernel hasn't seen the site yet, it runs an analysis against the live site and records what got in.
