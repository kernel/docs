...
<Info>
    Setting a custom viewport configuration triggers a Chromium restart, which can take several seconds. Use [browser pools](/browsers/scaling/pools) to access browsers with custom viewport configurations faster.
</Info>
