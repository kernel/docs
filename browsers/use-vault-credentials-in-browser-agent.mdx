...
copy this prompt into your coding agent. it uses hacker news as an example login form and asks you to enter your credentials yourself.
...
the sdk examples require typescript or python version `0.103.0` or later. all examples use the default project; use the same project for the vault and browser if you select a different one. retries are disabled explicitly for the sdk examples.
