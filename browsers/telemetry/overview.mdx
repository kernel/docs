...
Captured events are retained for 30 days, then expired. You can [stream](/browsers/telemetry/streaming) events live or pull them later for analysis within that window; after 30 days the events are no longer available. If your org has [Zero Data Retention](/info/zero-data-retention) enabled, telemetry isn't persisted at all.
