...
## Exporting to your own backend

You can also send a session's events to your own OpenTelemetry backend over OTLP/HTTP. Create a destination once for your organization, then select it with `telemetry.export.otlp.destination` when you create a browser. See [Export telemetry](/browsers/telemetry/export) for setup, limits, and how to confirm export is working.
...
- [Export telemetry](/browsers/telemetry/export) - send captured events to your own OpenTelemetry backend over OTLP.
