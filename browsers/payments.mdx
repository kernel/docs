...
<Warning>
  `fill` writes real values into the browser. page scripts, extensions, or agents with browser or cdp access may read them. don't assume recordings exclude filled values. keeping values out of the api handoff is not isolation from the browser.
</Warning>
