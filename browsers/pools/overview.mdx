...
- Browser pools allow you to provision browsers with your specific configuration ahead of time (such as stealth, proxies, extensions, and profiles), rather than the setup latency happening at agent runtime. 
