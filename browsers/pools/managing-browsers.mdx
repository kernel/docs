...
Browser pools accept an optional `chrome_policy` object that lets you apply [Chrome enterprise policy settings](https://chromeenterprise.google/policies/) to every browser in the pool. Use this to control startup behavior, default homepages, bookmarks, new tab pages, and other browser-level preferences.
