...
description: "Create browsers on-demand for your automation tasks"
---

Kernel browsers were designed to be lightweight, fast, and efficient for cloud-based browser automations at scale. You can create browsers on-demand, use them for your automation task, and tear them down when you're done. They can be used as part of the Kernel [app platform](/apps/develop) or connected to from another service with the Chrome DevTools Protocol.
