...
<Info>
    Loading an extension into a browser triggers a Chromium restart, which can take several seconds. Use [browser pools](/browsers/scaling/pools) to access browsers with extensions faster.
</Info>
