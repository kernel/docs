...
- **Long-lived session states** - Securely authenticate on behalf of your users with [Managed Auth](/profiles/managed-auth/overview). Browsers can run for up to 72 hours via [timeout configuration](/browsers/termination)
