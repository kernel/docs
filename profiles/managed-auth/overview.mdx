...
- **Account and org selection** - Handle account pickers and organization selectors via `sign_in_options`
- **Website error detection** - Surface login errors (e.g., "Incorrect password") via `website_error` so users can retry
