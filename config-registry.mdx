...
if not started.analysis:
    raise RuntimeError("analysis did not start")
...
the dashboard marks recommendations for the exact url as **Recommended** and host or domain fallbacks as **Inferred**. test an inferred recommendation against your workload before relying on it.
