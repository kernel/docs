...
for the payment-specific lifecycle, read the [payments overview](/integrations/payments/overview). to complete a checkout, follow [Add Payments to a Browser Agent](/browsers/add-payments-to-browser-agent).
