...
- **Marketplace plugin** — load Kernel's skills directly into Claude Code so it knows how to manage cloud browsers, write automations, and generate videos.
...
- **`generate-video`** — rendering smooth MP4s from a browser session with CDP frame-stepping and ffmpeg.

See the [skills repo](https://github.com/kernel/skills#claude-code) for the current list.
