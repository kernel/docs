...
When you use Kernel's [App platform](/apps/overview) or [Computer controls](/browsers/computer-controls), Laminar will automatically trace the computer and process interactions.
...
To deploy this example on Kernel, follow the steps in [Kernel's app deployment guide](/apps/build-deploy-operate#deploy-your-app).
...
- Learn how to [deploy your app](/apps/build-deploy-operate#deploy-your-app) to Kernel's platform
