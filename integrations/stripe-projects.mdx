...
|------------|------|-------|---------|
| `kernel/plan:developer` | plan | account | Developer plan — free, \$5/mo credits, 5 concurrent browsers |
...
| Stripe Project | Kernel project (API keys, sessions, browser pools, etc.) |
