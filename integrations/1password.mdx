...
<Note>
This page covers the service account integration for Managed Auth. For vault items where a user approves each request in the 1Password app, see [1Password credentials](/vaults/1password).
</Note>
