...
[Vibium](https://github.com/VibiumDev/vibium) is a browser automation library that provides a simple, consistent API for controlling Chrome across CLI, JavaScript, and Python. By integrating with Kernel, you can run Vibium automations with cloud-hosted browsers.
...
<CodeGroup>
```typescript TypeScript
await page.go("https://onkernel.com");
