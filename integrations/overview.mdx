...
- **[Docker Sandboxes](/integrations/docker-sandboxes)** - Give agents in Docker Sandboxes a Kernel cloud browser with the Kernel kit
...
- **[wallets](/integrations/wallets/overview)** - connect payment methods through native wallet integrations
