...
Pick a model above to get its template, then follow the [deploy](/apps/build-deploy-operate#deploy-your-app) and [invoke](/apps/build-deploy-operate#invoke-an-action) guides to run your agent on Kernel.
...
- Learn how to [deploy](/apps/build-deploy-operate#deploy-your-app) your computer use app to Kernel
