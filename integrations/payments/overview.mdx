...
configure [link](/integrations/payments/link) or [agentcard](/integrations/payments/agentcard), then follow [Pay Through a Browser Checkout](/browsers/pay-through-browser-checkout) to attach the vault and give payment aliases to your agent.
