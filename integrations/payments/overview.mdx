...
configure [link](/integrations/payments/link) or [agentcard](/integrations/payments/agentcard), then follow [Add Payments to a Browser Agent](/browsers/add-payments-to-browser-agent) to attach the vault and give payment aliases to your agent.
