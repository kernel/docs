...
- **link:** the browser agent receives a approved, provider-issued single-use card and then uses [fill](/vaults/fill) to write card values into an attached browser without exposing the card details to the application or model.
