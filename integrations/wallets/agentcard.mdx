...
Mercado Pago don't support the ordinary hold flow. Square supports either flow,
depending on whether prepared checkout is enabled. encrypted payloads, different
request layouts, and unrecognized processor endpoints pass through without native
handoff.
