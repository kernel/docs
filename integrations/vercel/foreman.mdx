...
Follow [Vercel's guide for building a browser agent](https://vercel.com/kb/guide/build-a-browser-agent) for the full recipe, including the shadowed connection and tool allowlist.
